...
export const interceptAccountDeposit = (body: RestAccount): Cypress.Chainable =>
  cy.intercept(`**/api/accounts/${body.id}/deposit`, {
    body,
  });

export const interceptAccountWithdraw = (body: RestAccount): Cypress.Chainable =>
  cy.intercept(`**/api/accounts/${body.id}/withdraw`, {
    body,
  });
